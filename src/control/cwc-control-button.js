 ...
 * @description Application Web Component, common component, button
 * @author Paul Smith <p@ulsmith.net>
 * @copyright 2020 and up Custom Web Component <custom-web-component.net> <ulsmith.net> <p@ulsmith.net>
 *
 * @example
 * <cwc-control-button @click="${this.test.bind(this)}" disabled>A Button</cwc-control-button>
 */
	...
	static template() {
		return html`
			<style>	
				...
				:host([context="primary"]:focus) .cwc-control-button { margin: 0; box-shadow: var(--cwc-control-button--primary--box-shadow--active, 0 0 0 1px lightblue); }
				...
				:host([context="secondary"]:focus) .cwc-control-button { margin: 0; box-shadow: var(--cwc-control-button--secondary--box-shadow--active, 0 0 0 1px lightgrey); }
				...
				:host([context="success"]) .cwc-control-button { background: var(--cwc-control-button--success--background, green); color: var(--cwc-control-button--success--color, white); fill: var(--cwc-control-button--success--color, white); border: var(--cwc-control-button--primary--border, 1px solid transparent); }
				...
				:host([context="warning"]) .cwc-control-button { background: var(--cwc-control-button--warning--background, orange); color: var(--cwc-control-button--warning--color, white); fill: var(--cwc-control-button--warning--color, white); border: var(--cwc-control-button--primary--border, 1px solid transparent); }
				...
				:host([context="danger"]) .cwc-control-button { background: var(--cwc-control-button--danger--background, red); color: var(--cwc-control-button--danger--color, white); fill: var(--cwc-control-button--danger--color, white); border: var(--cwc-control-button--primary--border, 1px solid transparent); }

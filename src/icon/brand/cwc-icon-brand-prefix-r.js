...
/**
 * @public @name CWCIconBrandPrefixR
 ...
 *
 * @example
 * <cwc-icon-brand-prefix-r name="foo"></cwc-icon-brand-prefix-r>
 */
class CWCIconBrandPrefixR extends CustomHTMLElement {
...
customElements.define('cwc-icon-brand-prefix-r', CWCIconBrandPrefixR);
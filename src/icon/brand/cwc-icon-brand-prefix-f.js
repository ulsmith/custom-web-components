...
/**
 * @public @name CWCIconBrandPrefixF
 ...
 *
 * @example
 * <cwc-icon-brand-prefix-f name="foo"></cwc-icon-brand-prefix-f>
 */
class CWCIconBrandPrefixF extends CustomHTMLElement {
...
customElements.define('cwc-icon-brand-prefix-f', CWCIconBrandPrefixF);
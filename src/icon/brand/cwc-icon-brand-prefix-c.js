...
/**
 * @public @name CWCIconBrandPrefixC
 ...
 *
 * @example
 * <cwc-icon-brand-prefix-c name="foo"></cwc-icon-brand-prefix-c>
 */
class CWCIconBrandPrefixC extends CustomHTMLElement {
...
customElements.define('cwc-icon-brand-prefix-c', CWCIconBrandPrefixC);
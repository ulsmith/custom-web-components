...
/**
 * @public @name CWCIconBrandPrefixV
 ...
 *
 * @example
 * <cwc-icon-brand-prefix-v name="foo"></cwc-icon-brand-prefix-v>
 */
class CWCIconBrandPrefixV extends CustomHTMLElement {
...
customElements.define('cwc-icon-brand-prefix-v', CWCIconBrandPrefixV);
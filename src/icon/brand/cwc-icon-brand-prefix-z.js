...
/**
 * @public @name CWCIconBrandPrefixZ
 ...
 *
 * @example
 * <cwc-icon-brand-prefix-z name="foo"></cwc-icon-brand-prefix-z>
 */
class CWCIconBrandPrefixZ extends CustomHTMLElement {
...
customElements.define('cwc-icon-brand-prefix-z', CWCIconBrandPrefixZ);
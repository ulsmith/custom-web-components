...
/**
 * @public @name CWCIconBrandPrefixS
 ...
 *
 * @example
 * <cwc-icon-brand-prefix-s name="foo"></cwc-icon-brand-prefix-s>
 */
class CWCIconBrandPrefixS extends CustomHTMLElement {
...
customElements.define('cwc-icon-brand-prefix-s', CWCIconBrandPrefixS);
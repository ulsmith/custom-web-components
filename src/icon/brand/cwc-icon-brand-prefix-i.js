...
/**
 * @public @name CWCIconBrandPrefixI
 ...
 *
 * @example
 * <cwc-icon-brand-prefix-i name="foo"></cwc-icon-brand-prefix-i>
 */
class CWCIconBrandPrefixI extends CustomHTMLElement {
...
customElements.define('cwc-icon-brand-prefix-i', CWCIconBrandPrefixI);
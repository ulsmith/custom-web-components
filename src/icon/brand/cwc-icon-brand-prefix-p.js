...
/**
 * @public @name CWCIconBrandPrefixP
 ...
 *
 * @example
 * <cwc-icon-brand-prefix-p name="foo"></cwc-icon-brand-prefix-p>
 */
class CWCIconBrandPrefixP extends CustomHTMLElement {
...
customElements.define('cwc-icon-brand-prefix-p', CWCIconBrandPrefixP);
...
/**
 * @public @name CWCIconBrandPrefixA
 ...
 *
 * @example
 * <cwc-icon-brand-prefix-a name="foo"></cwc-icon-brand-prefix-a>
 */
class CWCIconBrandPrefixA extends CustomHTMLElement {
...
customElements.define('cwc-icon-brand-prefix-a', CWCIconBrandPrefixA);
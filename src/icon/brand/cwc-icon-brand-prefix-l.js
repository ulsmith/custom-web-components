...
/**
 * @public @name CWCIconBrandPrefixL
 ...
 *
 * @example
 * <cwc-icon-brand-prefix-l name="foo"></cwc-icon-brand-prefix-l>
 */
class CWCIconBrandPrefixL extends CustomHTMLElement {
...
customElements.define('cwc-icon-brand-prefix-l', CWCIconBrandPrefixL);
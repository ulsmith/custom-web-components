...
/**
 * @public @name CWCIconBrandPrefixW
 ...
 *
 * @example
 * <cwc-icon-brand-prefix-w name="foo"></cwc-icon-brand-prefix-w>
 */
class CWCIconBrandPrefixW extends CustomHTMLElement {
...
customElements.define('cwc-icon-brand-prefix-w', CWCIconBrandPrefixW);
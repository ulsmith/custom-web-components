...
/**
 * @public @name CWCIconBrandPrefixQ
 ...
 *
 * @example
 * <cwc-icon-brand-prefix-q name="foo"></cwc-icon-brand-prefix-q>
 */
class CWCIconBrandPrefixQ extends CustomHTMLElement {
...
customElements.define('cwc-icon-brand-prefix-q', CWCIconBrandPrefixQ);
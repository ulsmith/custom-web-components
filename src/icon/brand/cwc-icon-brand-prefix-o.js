...
/**
 * @public @name CWCIconBrandPrefixO
 ...
 *
 * @example
 * <cwc-icon-brand-prefix-o name="foo"></cwc-icon-brand-prefix-o>
 */
class CWCIconBrandPrefixO extends CustomHTMLElement {
...
customElements.define('cwc-icon-brand-prefix-o', CWCIconBrandPrefixO);
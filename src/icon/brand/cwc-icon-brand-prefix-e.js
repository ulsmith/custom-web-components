...
/**
 * @public @name CWCIconBrandPrefixE
 ...
 *
 * @example
 * <cwc-icon-brand-prefix-e name="foo"></cwc-icon-brand-prefix-e>
 */
class CWCIconBrandPrefixE extends CustomHTMLElement {
...
customElements.define('cwc-icon-brand-prefix-e', CWCIconBrandPrefixE);
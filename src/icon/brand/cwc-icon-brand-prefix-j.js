...
/**
 * @public @name CWCIconBrandPrefixJ
 ...
 *
 * @example
 * <cwc-icon-brand-prefix-j name="foo"></cwc-icon-brand-prefix-j>
 */
class CWCIconBrandPrefixJ extends CustomHTMLElement {
...
customElements.define('cwc-icon-brand-prefix-j', CWCIconBrandPrefixJ);
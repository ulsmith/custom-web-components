...
/**
 * @public @name CWCIconBrandPrefixX
 ...
 *
 * @example
 * <cwc-icon-brand-prefix-x name="foo"></cwc-icon-brand-prefix-x>
 */
class CWCIconBrandPrefixX extends CustomHTMLElement {
...
customElements.define('cwc-icon-brand-prefix-x', CWCIconBrandPrefixX);
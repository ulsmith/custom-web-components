...
/**
 * @public @name CWCIconBrandPrefixU
 ...
 *
 * @example
 * <cwc-icon-brand-prefix-u name="foo"></cwc-icon-brand-prefix-u>
 */
class CWCIconBrandPrefixU extends CustomHTMLElement {
...
customElements.define('cwc-icon-brand-prefix-u', CWCIconBrandPrefixU);
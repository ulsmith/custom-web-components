...
/**
 * @public @name CWCIconBrandPrefixH
 ...
 *
 * @example
 * <cwc-icon-brand-prefix-h name="foo"></cwc-icon-brand-prefix-h>
 */
class CWCIconBrandPrefixH extends CustomHTMLElement {
...
customElements.define('cwc-icon-brand-prefix-h', CWCIconBrandPrefixH);
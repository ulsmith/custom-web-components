...
/**
 * @public @name CWCIconBrandPrefixD
 ...
 *
 * @example
 * <cwc-icon-brand-prefix-d name="foo"></cwc-icon-brand-prefix-d>
 */
class CWCIconBrandPrefixD extends CustomHTMLElement {
...
customElements.define('cwc-icon-brand-prefix-d', CWCIconBrandPrefixD);
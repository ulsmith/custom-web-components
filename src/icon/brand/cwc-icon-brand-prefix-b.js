...
/**
 * @public @name CWCIconBrandPrefixB
 ...
 *
 * @example
 * <cwc-icon-brand-prefix-b name="foo"></cwc-icon-brand-prefix-b>
 */
class CWCIconBrandPrefixB extends CustomHTMLElement {
...
customElements.define('cwc-icon-brand-prefix-b', CWCIconBrandPrefixB);
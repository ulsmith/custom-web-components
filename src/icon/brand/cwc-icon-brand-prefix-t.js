...
/**
 * @public @name CWCIconBrandPrefixT
 ...
 *
 * @example
 * <cwc-icon-brand-prefix-t name="foo"></cwc-icon-brand-prefix-t>
 */
class CWCIconBrandPrefixT extends CustomHTMLElement {
...
customElements.define('cwc-icon-brand-prefix-t', CWCIconBrandPrefixT);
...
/**
 * @public @name CWCIconBrandPrefixK
 ...
 *
 * @example
 * <cwc-icon-brand-prefix-k name="foo"></cwc-icon-brand-prefix-k>
 */
class CWCIconBrandPrefixK extends CustomHTMLElement {
...
customElements.define('cwc-icon-brand-prefix-k', CWCIconBrandPrefixK);
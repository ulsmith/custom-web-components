...
/**
 * @public @name CWCIconBrandPrefixM
 ...
 *
 * @example
 * <cwc-icon-brand-prefix-m name="foo"></cwc-icon-brand-prefix-m>
 */
class CWCIconBrandPrefixM extends CustomHTMLElement {
...
customElements.define('cwc-icon-brand-prefix-m', CWCIconBrandPrefixM);